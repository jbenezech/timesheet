...
define('components/top-bar',['exports', 'aurelia-framework', 'aurelia-i18n', 'aurelia-dialog', 'aurelia-event-aggregator', '../resources/confirmation/confirmation', '../services/db-service', '../services/session', '../config/app-settings', '../environment', '../services/log'], function (exports, _aureliaFramework, _aureliaI18n, _aureliaDialog, _aureliaEventAggregator, _confirmation, _dbService, _session, _appSettings, _environment, _log) {
    'use strict';
    ...
    var TopBar = exports.TopBar = (_dec = (0, _aureliaFramework.inject)(_session.Session, _aureliaI18n.I18N, _dbService.DBService, _aureliaDialog.DialogService, _aureliaEventAggregator.EventAggregator), _dec(_class = function () {
        ...
        TopBar.prototype.wipeAll = function wipeAll() {
            this.db.wipeAllDBs();
        };

        TopBar.prototype.replicateAll = function replicateAll() {
        ...
        _createClass(TopBar, [{
            key: 'isTest',
            get: function get() {
                return _environment2.default.testing;
            }
        }, {
            key: 'isAdmin',
            get: function get() {
        ...
        AccountingService.prototype.retrieveRules = function retrieveRules(accountingRuleEndKey) {
            ...
            return this.db.view('accounting', 'accounting/rules', accountingRuleEndKey, '', false, true, 1).then(function (rows) {
                ...
                _this.rules.set(row.key, {
                    ...
                    urssaf: new _decimal2.default(row.value[5])
                });
            });
        };
...
define('services/db-service',['exports', 'aurelia-framework', './session', 'pouchdb', 'pouchdb-upsert', 'moment', 'aurelia-event-aggregator', 'aurelia-fetch-client', './log', '../config/app-settings', './sharding-service', '../environment'], function (exports, _aureliaFramework, _session, _pouchdb, _pouchdbUpsert, _moment, _aureliaEventAggregator, _aureliaFetchClient, _log, _appSettings, _shardingService, _environment) {
    'use strict';
    ...
    var DBService = exports.DBService = (_dec = (0, _aureliaFramework.inject)(_session.Session, _shardingService.ShardingService, _aureliaFetchClient.HttpClient, _aureliaEventAggregator.EventAggregator), _dec2 = (0, _aureliaFramework.singleton)(), _dec(_class = _dec2(_class = function () {
        function DBService(session, sharding, http, ea) {
            ...
            this.liveReplicates = ['^accounting$', '^interpret$', '^purpose$', '^timesheet\-{0}$'];
        ...
        DBService.prototype.getDB = function getDB(dbName) {
            ...
            if (!this.dbs.has(dbName)) {
                return this.setupDB(dbName).then(function (db) {
                    _this.dbs.set(dbName, db);
                    return db;
                });
            }

            return new Promise(function (resolve) {
                return resolve(_this.dbs.get(dbName));
            });
        };
        ...
        DBService.prototype.setupDB = function setupDB(dbName) {
            ...
            if (_environment2.default.testing) {
                return db.replicate.from(this.sharding.getRemoteUrl() + dbName).then(function () {
                    return db;
                });
            }
        ...
        DBService.prototype.isLiveReplicate = function isLiveReplicate(dbName) {
        ...
        DBService.prototype.handleUpdateError = function handleUpdateError(db, doc, err) {
            ...
            if (err.status === 409 && err.name === 'conflict') {
                db.upsert(doc._id, function () {
                    ...
                    _log.log.error(err);
                    _this2.ea.publish('dberr', { dbName: db.name, doc: doc, err: err });
                });
            }
        };
        ...
        DBService.prototype.removeDBs = function removeDBs() {
            ...
            return Promise.all(promises).then(function () {
                ...
                _this3.lastUpdates.clear();
                _this3.lastSyncs.clear();
                return new Promise(function (resolve) {
                    return resolve();
                });
            });
        ...
        DBService.prototype.wipeAllDBs = function wipeAllDBs() {

            var me = this;
            var promises = [];

            this.dbs.forEach(function (db, dbName) {
                var promise = me.list(dbName).then(function (rows) {
        ...
        DBService.prototype.listUsers = function listUsers() {
            ...
            return this.http.fetch(this.sharding.getRemoteUrl() + '_users/_all_docs?include_docs=true').then(function (response) {
                ...
                return Promise.all(users.rows.filter(function (user) {
                    ...
                    return _this4.createOrReplaceLocalUser(localUser);
                }));
        ...
        DBService.prototype.list = function list(dbName) {
            ...
            return this.getDB(dbName).then(function (db) {
                return db.allDocs(firstRequestOptions).then(function (results) {

                    return db.allDocs(secondRequestOptions).then(function (endResults) {
        ...
        DBService.prototype.view = function view(dbName, viewName) {
            ...
            return this.getDB(dbName).then(function (db) {
                return db.query(viewName, options).then(function (response) {
        ...
        DBService.prototype.replicate = function replicate(db) {
            var me = this;
            return db.replicate.to(this.sharding.getRemoteUrl() + db.name).then(function (result) {
        ...
        DBService.prototype.replicateAllDBs = function replicateAllDBs() {
            var me = this;
            var promises = [];
            ...
            return this.getDB(dbName).then(function (db) {
                ...
                return db.put(doc).then(function (response) {
                    if (!me.isLiveReplicate(dbName)) {
                        return me.replicate(db).then(function (success) {
                            return response;
                        });
                    }
...
define('pages/admin/admin-router',['exports', 'aurelia-framework', 'aurelia-router', 'aurelia-i18n'], function (exports, _aureliaFramework, _aureliaRouter, _aureliaI18n) {
    'use strict';
    ...
    var AdminRouter = exports.AdminRouter = (_dec = (0, _aureliaFramework.inject)(_aureliaRouter.Router, _aureliaI18n.I18N), _dec(_class = function () {
        function AdminRouter(router, i18n) {
    ...
    var UserTimesheet = exports.UserTimesheet = (_dec = (0, _aureliaFramework.inject)(_dbService.DBService, _aureliaI18n.I18N, _aureliaFramework.NewInstance.of(_aureliaValidation.ValidationController), _adminRouter.AdminRouter), _dec(_class = (_class2 = function () {
        ...
        UserTimesheet.prototype.saveTimesheet = function saveTimesheet(userName) {
            ...
            var errors = this.controller.validate().then(function (result) {
                ...
                _this.timesheet.precarite = $('.' + _this.userName + ' .precarite.checkbox').checkbox('is checked');
    ...
    var TimesheetEntry = exports.TimesheetEntry = (_dec = (0, _aureliaFramework.inject)(Element, _session.Session, _dbService.DBService, _aureliaI18n.I18N, _aureliaEventAggregator.EventAggregator, _timesheetsRouter.TimesheetsRouter, _aureliaFramework.NewInstance.of(_aureliaValidation.ValidationController)), _dec(_class = (_class2 = function () {
        ...
        TimesheetEntry.prototype.doSave = function doSave(event) {
            ...
            var errors = this.controller.validate().then(function (result) {
                ...
                _this.entity.hours = parseInt(_this.entity.hours);
                _this.entity.minutes = parseInt(_this.entity.minutes);
                _this.entity.interpret_hours = parseInt(_this.entity.interpret_hours);
                _this.entity.interpret_minutes = parseInt(_this.entity.interpret_minutes);
                _this.entity.duration = _this.entity.hours + parseFloat(_this.entity.minutes / 60);
                _this.entity.interpret_duration = _this.entity.interpret_hours + parseFloat(_this.entity.interpret_minutes / 60);
...
define('pages/timesheets/timesheets-router',['exports', 'aurelia-framework', 'aurelia-router', 'aurelia-i18n'], function (exports, _aureliaFramework, _aureliaRouter, _aureliaI18n) {
    'use strict';
    ...
    var TimesheetsRouter = exports.TimesheetsRouter = (_dec = (0, _aureliaFramework.inject)(_aureliaRouter.Router, _aureliaI18n.I18N), _dec(_class = function () {
        function TimesheetsRouter(router, i18n) {
